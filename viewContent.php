...
switch ($option) {
    ...
    case 'nurseryViewProduct':
        ...
        break;
    case 'viewOrder':
        $sql = 'SELECT O.oid, I.iname, P.pname, P.price, O.quantity, username, U.phone, N.name, U.id, N.nur_email FROM Product_Order as O INNER JOIN Product as P ON O.pid = P.pid INNER JOIN Nursery as N ON N.nid = P.nid INNER JOIN Image as I ON P.img_id = I.img_id INNER JOIN User as U ON U.id = O.uid';
        break;
